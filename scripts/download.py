...
'''
This script belongs to "Natural Image Noise Dataset" project
link: https://commons.wikimedia.org/wiki/Natural_Image_Noise_Dataset
flag `target_dir` default parameter was changed 
from `datasets/NIND` to `data`.
'''
